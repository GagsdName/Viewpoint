...
<body>
<table id="managecategory" cellspacing="160px">

<tr>
<td><a href="<%=dbreflib.URL.url+"create_category.jsp"%>" ><img src="images/add.png" class="thumbnail"></img></a><br><label class="thumblabel">Create a Category</label></td>
<td><a href="<%=dbreflib.URL.url+"delete_category.jsp"%>" ><img src="images/delete.png"  class="thumbnail"></img></a><br><label class="thumblabel">Delete a Category</label></td>
